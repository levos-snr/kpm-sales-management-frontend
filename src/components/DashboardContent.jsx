...
import  QuickActionsOrders  from './QuickActionsOrders'
import SalesTargetDialog from './SalesTargetDialog';
import QuickActionsCustomers from './QuickActionsCustomers';
...
export const DashboardContent = () => {
  ...
  const handleSetTarget = async (targetData) => {
    try {
      // Add your API call here to save the target
      // await axios.post('/api/sales-targets', targetData);
      ...
      // setSuccess('Sales target set successfully');
    } catch (error) {
      console.error('Error setting sales target:', error);
      // Optional: Show error message
      // setError('Failed to set sales target');
    }
  };
        ...
        <CardContent>
          <Tabs defaultValue="sales" className="w-full">
            ...
            <TabsContent value="customers" className="space-y-4">
              <div className="flex flex-wrap gap-4 mt-4">
                <QuickActionsCustomers />
                <Button>
                  <MapPin className="mr-2 h-4 w-4" /> Set locations
                </Button>
                <Button>
